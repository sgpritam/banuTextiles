        ...
        <div class="row">
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="single-items mb-20">
              <div class="items-img">
                <img
                  src={process.env.PUBLIC_URL + "/images/items1.jpg"}
                  alt=""
                />
              </div>
              <div class="items-details">
                ...
                <a href="pro-details.html" class="browse-btn">
                  Shop Now
                </a>
              </div>
            </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="single-items mb-20">
              <div class="items-img">
                <img
                  src={process.env.PUBLIC_URL + "/images/items2.jpg"}
                  alt=""
                />
              </div>
              <div class="items-details">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="single-items mb-20">
              <div class="items-img">
                <img
                  src={process.env.PUBLIC_URL + "/images/items3.jpg"}
                  alt=""
                />
              </div>
              <div class="items-details">
